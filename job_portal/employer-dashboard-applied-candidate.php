                            ...
                            <div class="careerfy-employer-box-section">
                                ...
                                <div class="careerfy-employer-resumes">
                                    <ul class="careerfy-row">
                                        <?php
                                            ...
                                            $q_applicant = "select * from job_apply_job_post where status= 1 LIMIT $start_from,  $per_page";
                                ...
                                <div class="careerfy-pagination-blog">
                                    <ul class="page-numbers">
                                        <?php
                                            $query5 = "select * from  job_apply_job_post where status= 1";
                                            $result5 = mysqli_query($con, $query5);
                                            $total_record = mysqli_num_rows($result5);
                                            $total_pages = ceil($total_record / $per_page);

                                            echo "
                                                <li><a href='employer-dashboard-applied-candidate.php?page=1'>" . ' ' . "</a></li>";

                                            for ($i = 1; $i <= $total_pages; $i++) {
                                                echo "
                                                    <li><a href='employer-dashboard-applied-candidate.php?page=" . $i . "'>" . $i . "</a></li>";
                                            }

                                            echo "
                                                    <li><a href='employer-dashboard-applied-candidate.php?page=$total_pages'>" . ' ' . "</a></li>";
